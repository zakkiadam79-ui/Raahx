...
import { Sparkles, Target, Eye, Layers, ArrowLeft, ArrowRight } from "lucide-react";

export default function AboutPage() {
  return (
    <div className="min-h-screen bg-background text-gray-900 font-body">
      {/* Hero */}
      <section className="pt-32 md:pt-40 pb-16 bg-gray-50/50">
        <div className="max-w-5xl mx-auto px-6 lg:px-8 text-center">
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-sm font-medium text-gray-600 bg-white px-4 py-2 rounded-full border border-gray-200 hover:border-primary/30 hover:text-primary shadow-sm mb-8 transition-colors"
          >
      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        ...
        <div className="p-8 md:p-12 bg-secondary rounded-3xl mb-20">
      ...
      <section className="py-20 bg-secondary text-center">
        <div className="max-w-2xl mx-auto px-6 lg:px-8">
          ...
          <p className="text-gray-400 mb-8">
            Partner with RaahX to build a stronger brand, attract more customers, and achieve measurable growth.
          </p>
          <Link
            to="/#proposal"
            className="inline-flex items-center gap-2 bg-primary hover:bg-primary-dark text-white font-medium px-8 py-4 rounded-full transition-colors"
          >
